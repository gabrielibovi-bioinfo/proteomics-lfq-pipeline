...
limma_res <- read.csv("limma_rlr_BH/per_contrast_results/MO_vs_SC.csv", stringsAsFactors = FALSE)
...
print(go_dot1)
# ggsave("gsea_GO/01_GSEA_GO_ontology.tiff", plot = go_dot1, width = 9, height = 7, dpi = 400, compression = "lzw")
...
print(go_dot2)
# ggsave("gsea_GO/02_GSEA_GO_direction.tiff", plot = go_dot2, width = 9, height = 6, dpi = 400, compression = "lzw")
...
print(go_heat)
# ggsave("gsea_GO/03_GSEA_GO_heatplot.tiff", plot = go_heat, width = 10, height = 5, dpi = 400, compression = "lzw")
...
print(go_ridge)
# ggsave("gsea_GO/04_GSEA_GO_ridgeplot.tiff", plot = go_ridge, width = 8, height = 6, dpi = 400, compression = "lzw")
...
go_gsea5 <- gseaplot2(gsea_go, geneSetID = 1:5, color = c("yellow3", "darkblue", "darkolivegreen", "chocolate", "seagreen"))
# ggsave("gsea_GO/11_GSEA_GO_top5_rank.tiff", plot = go_gsea5, width = 7, height = 5, dpi = 400, compression = "lzw")

# --- 2.5: Network plot (cnetplot) ---
# Shows linkages between genes and enriched GO terms
go_cnet <- cnetplot(gsea_go, showCategory = 10, categorySize = "pvalue", color.params = list(foldChange = gene_list))
# ggsave("gsea_GO/12_GSEA_GO_cnetplot.tiff", plot = go_cnet, width = 12, height = 10, dpi = 400, compression = "lzw")
...
# ggsave("gsea_GO/13_GSEA_GO_emapplot.tiff", plot = go_emap, width = 10, height = 7, dpi = 400, compression = "lzw")
...
# write.csv(gsea_kegg_df,"gsea_kegg/GSEA_KEGG_MO_vs_SC.csv",row.names = FALSE)
...
kegg_gsea5 <- gseaplot2(gsea_kegg, geneSetID = 1:5, color = c("yellow3", "darkblue", "darkolivegreen", "chocolate", "seagreen"))
# ggsave("gsea_kegg/11_GSEA_KEGG_top5_rank.tiff", plot = kegg_gsea5, width = 7, height = 5, dpi = 400, compression = "lzw")

# --- 3.5: Network plot ---
kegg_cnet <- cnetplot(gsea_kegg, showCategory = 10, categorySize = "pvalue",color.params = list(foldChange = gene_list))
...
kegg_emap <- emapplot(gsea_kegg_sim, showCategory = 15)
...
reac_gsea5 <- gseaplot2(gsea_reactome, geneSetID = 1:5,color = c("yellow3", "darkblue", "darkolivegreen", "chocolate", "seagreen"))
# ggsave("gsea_reactome/11_GSEA_Reactome_top5_rank.tiff", plot = reac_gsea5, width = 7, height = 5, dpi = 400, compression = "lzw")

# --- 4.5: Network plot ---
reac_cnet <- cnetplot(gsea_reactome, showCategory = 10, categorySize = "pvalue",
...
reac_emap     <- emapplot(gsea_reac_sim, showCategory = 15)
